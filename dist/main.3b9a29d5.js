...
var $addBtn = $('.addBtn');
var $siteList = $('.siteList'); //使用localStorage防止数据丢失

var hashObj = JSON.parse(localStorage.getItem('info'));
var hashMap = hashObj || [{
  logo: 'B',
...
$('.addBtn').on('click', function () {
  var url = window.prompt('你想添加的网址是啥？');
...
//# sourceMappingURL=main.3b9a29d5.js.map